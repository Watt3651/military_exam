        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 border-b border-gray-200 flex items-center justify-between flex-wrap gap-3">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">รายการพื้นที่ชายแดนทั้งหมด พร้อมคะแนนพิเศษและสถานะการใช้งาน</p>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">คะแนนพิเศษ</th>
                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">สถานะ (เปิด/ปิด)</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        @forelse ($areas as $area)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">{{ $area->code }}</td>
