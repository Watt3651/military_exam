        ...
        <nav x-data="{ open: false }" class="menu-nav bg-dark-600 border-b border-primary-700 shadow-lg">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link :href="route('examinee.dashboard')"
                                :active="request()->routeIs('examinee.dashboard')"
                            ...
                            <x-nav-link :href="route('examinee.register-exam')"
                                :active="request()->routeIs('examinee.register-exam')"
                                class="text-black hover:text-blue-600 border-blue-300">
                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <x-nav-link :href="route('examinee.profile')"
                                :active="request()->routeIs('examinee.profile')"
                                class="text-black hover:text-blue-600 border-blue-300">
                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <x-nav-link :href="route('examinee.history')"
                                :active="request()->routeIs('examinee.history')"
                                class="text-black hover:text-blue-600 border-blue-300">
                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('examinee.dashboard')"
                        :active="request()->routeIs('examinee.dashboard')"
                        class="text-black hover:text-blue-600 hover:bg-blue-50">
                        หน้าหลัก
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('examinee.register-exam')"
                        :active="request()->routeIs('examinee.register-exam')"
                        class="text-black hover:text-blue-600 hover:bg-blue-50">
                        ลงทะเบียนสอบ
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('examinee.profile')"
                        :active="request()->routeIs('examinee.profile')"
                        class="text-black hover:text-blue-600 hover:bg-blue-50">
                        ข้อมูลส่วนตัว
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('examinee.history')"
                        :active="request()->routeIs('examinee.history')"
                        class="text-black hover:text-blue-600 hover:bg-blue-50">
                        ประวัติการสอบ
                    </x-responsive-nav-link>
